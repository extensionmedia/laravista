...
@section('content')
    ...
    <div class="mx-auto w-full xl:w-2/3 px-4 lg:px-8">
        ...
        <div class="w-full h-52 overflow-hidden rounded-b-lg">
          <img class="screen object-cover min-w-full h-full z-0" src="/storage/images/office.jpg" alt="{{config('app.name')}} : A-Propos">
        </div>
        <h1 class="text-gray-600 text-2xl font-bold mt-8">
            A propos de {{config('app.name')}}.com
        </h1>
    </div>
    <div class="mx-auto w-full xl:w-2/3 px-4 lg:px-8 mt-8 mb-12">
        <div class="w-full">
            ...
            <p class="text-sm my-4">
                Nous avons un nombre important de visiteurs uniques qui, chaque mois, consultent les 2354 annonces regroupés en 8 catégories (Immobilier, Vehicules, Maison et Jardins, Multimedia, Emploi, Loisirs, Vacances et Services) proposés par {{config('app.name')}}.com.
            </p>
        </div>
    </div>
@endsection
