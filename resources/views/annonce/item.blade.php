<a href="{{route('annonce.show', $annonce)}}" class="md:flex border rounded-lg mb-4 overflow-hidden cursor-pointer hover:shadow hover:border-blue-200">
    <div class="w-full md:w-60 max-h-36 overflow-hidden relative">
        ...
        <div class="rounded-lg text-xs px-1 py-1 bg-blue-100 bg-opacity-20 absolute top-0 m-2">
        ...
        <div class="flex flex-col justify-between h-full">
            <div class="">
                <div class="flex justify-between items-center mb-1">
                    ...
                    <div class="rounded border border-blue-300 text-blue-300 text-xs py-0 px-4 hidden">
                        PRO
                    </div>
                </div>
            ...
            <div class="">
                <div class="flex justify-between items-end">
                    <div class="text-xs text-gray-400">
                        ...
                        <p class="text-blue-800 font-bold pt-2" style="font-size:10px">
                            <i class="far fa-clock"></i> {{ $annonce['created_at']->diffForHumans() }}
                        </p>
                    </div>
                    <div class="flex gap-2 pb-2">
                        <button class="hover:text-blue-300 hover:font-bold text-lg add_this_to_favorite" data-action="1" value="{{$annonce->id}}"><i class="far fa-heart"></i> <span class="text-xs text-gray-300"> {{$annonce->favorites->count()}}</span></button>
